...
CN.dart = (function($, CN, $D) {
    ...
    var
        ...
        common = {
            ...
            zone            : "",
            configFile      : '',           /*  dart config file */
            configLoaded    : false,
            configData      : {},
            gptAdsParams    : {},
            gptAdSlotSizes  : {
                                "728x90_top"                : [[728, 90], [970, 418], [970, 250], [970, 66], [62, 88], [88, 31], [196, 31]],
                                ...
                                "300x250_interstitial_top"  : [[300, 252], [300, 602], [900, 600]],
                                ...
                                "320x51_bottom"             : [[300, 51], [320, 51], [300, 151], [320, 151]],
        ...
        init = function(pars) {
            ...
            common.configFile = pars.configFile || '';
            loadConfigFile(pars);
        ...
        afterConfigInit = function(pars){
            ...
            common.gptAdKey = pars.networkId || "3379"; //default to Conde's Network if not passed 
            ...
            if(gptAdsRendered === false){
                for(var ind=0; ind<gptAds.length; ind++){
                    if(ind === 1){
                        ...
                        var adSlot,
                            adSlotArray = (gptAds[ind].xkws && gptAds[ind].xkws.length > 0) ? common.gptAdSlotSizes[gptAds[ind].adsize[0] +"x"+ gptAds[ind].adsize[1] +"_"+ gptAds[ind].xkws[0]] : common.gptAdSlotSizes[gptAds[ind].adsize[0] +"x"+ gptAds[ind].adsize[1]];
                ...
                if(!slideshowInterstitialAds.drawn){
                    var lotameKeywords = buildParams(slideshowInterstitialAds),
                        keywords,
                        adSlot,
                        extra = ( slideshowInterstitialAds.xkws && slideshowInterstitialAds.xkws[1].length > 0 ) ? "_"+slideshowInterstitialAds.xkws[1] : "",
                        adSlotArray = (slideshowInterstitialAds.xkws && slideshowInterstitialAds.xkws.length > 0) ? common.gptAdSlotSizes[slideshowInterstitialAds.adsize[0] +"x"+ slideshowInterstitialAds.adsize[1] +"_"+ slideshowInterstitialAds.xkws[0] +
                        extra] : common.gptAdSlotSizes[slideshowInterstitialAds.adsize[0] +"x"+ slideshowInterstitialAds.adsize[1]],
                        aamUUID = CN.cookie.get("aam_uuid");
