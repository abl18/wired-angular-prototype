...
<html>
	<head>
		...
		<link href="css/states-sprite.css" rel="stylesheet" />
	</head>
	<body>
		<h2>SVG</h2>
		<div class="icon-test-container svg ">
				...
				<div class="icon-test-size">
					...
					<span class="ball" title="ball"></span>
					
					<span class="ball:hover" title="ball:hover"></span>
					
					<span class="ball:active" title="ball:active"></span>
